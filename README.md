...
Нижче розміщено placeholder-зображення. Воно показує, де в README можна розмістити реальний скріншот програми. Файл можна замінити зображенням із таким самим шляхом або змінити посилання на власний скріншот.

![Приклад розташування елементів інтерфейсу](docs/screenshots/application-placeholder.svg)

На реальному скріншоті бажано показати:

- дерево обладнання зліва;
- схему підстанції в центральній частині;
- панель параметрів справа;
- графіки моніторингу;
- журнал подій у нижній частині вікна.
