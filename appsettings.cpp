...
void applyTheme(QApplication& application, ThemeMode theme) {
    ...
    if (theme == ThemeMode::System) {
        ...
        const QString resourcePath = theme == ThemeMode::Dark ? QStringLiteral(":/dark/stylesheet.qss")
...
bool applyLanguage(QApplication& application, const QString& language, QTranslator& translator) {
    ...
    if (!translator.load(QStringLiteral(":/i18n/app_uk.qm")) &&
        !translator.load(QStringLiteral(":/translations/app_uk.qm"))) {
        return false;
    }
