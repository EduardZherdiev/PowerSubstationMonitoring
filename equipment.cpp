...
Equipment::Equipment(const QString& name, const QString& type, const QString& status, const QString& location,
                     const QString& description, const QMap<QString, QString>& parameters, Equipment* parent)
    : m_name(name), m_type(type), m_status(status), m_location(location), m_description(description),
      m_parameters(parameters), m_parent(parent) {}
...
void Equipment::update(const QString& type, const QString& status, const QString& location, const QString& description,
