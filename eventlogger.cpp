...
EventLogger::EventLogger(QObject* parent) : QObject{parent}, m_records(HistoryPersistence::loadEvents()) {}
...
QVector<EventRecord> EventLogger::records(const QDateTime& from, const QDateTime& to,
