...
SensorTelemetrySimulator::SensorTelemetrySimulator() : m_phase(0.0), m_breakerClosed(true) {}
...
bool SensorTelemetrySimulator::tryReadSnapshot(SensorSnapshot* result) {
    ...
    if (snapshot.sourceVoltageKv < 320.0) {
        snapshot.notes.append(
            QCoreApplication::translate("SensorTelemetry", "Source voltage dropped below expected range"));
    }
